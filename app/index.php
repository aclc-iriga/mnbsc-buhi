...
$routes = [
    [ "name" => "Tabulation"      , "route" => "/mnbsc-buhi"            ],
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >mnbsc-buhi</h1>
                <p class="fst-italic" >Mutya nin Bagong Santa Clara (Buhi, Camarines Sur)</p>
            </div>
